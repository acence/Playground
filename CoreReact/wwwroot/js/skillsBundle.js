        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'tbody',
                    null,
                    this.props.data.map(function (valueItem) {
                        return _react2.default.createElement(
                            'tr',
                            { key: valueItem.id },
                            _this2.props.columns.map(function (item) {
                                return _react2.default.createElement(
                                    'td',
                                    { key: valueItem.id + '' + item.header },
...
Grid.propTypes = {
    ...
    options: _propTypes2.default.shape({
        ...
        addButtonAction: _propTypes2.default.bool,
        editButtonAction: _propTypes2.default.bool,
        deleteButtonAction: _propTypes2.default.bool
    })
};

exports.default = Grid;

},{"prop-types":18,"react":"react"}],2:[function(require,module,exports){
'use strict';
...
var currentSkillsRequest = void 0;
function getSkills() {
    return function (dispatch) {
        if (currentSkillsRequest && currentSkillsRequest.abort) {
            currentSkillsRequest.abort();
        }
        currentSkillsRequest = _Ajax2.default.get('/api/skills');
...
},{"./../../../Infrastructure/Ajax":2,"./../constants":8}],4:[function(require,module,exports){
'use strict';
...
exports.default = EditSkillDialog;
...
var SkillsGrid = function (_React$Component) {
    ...
    _createClass(SkillsGrid, [{
        ...
        key: 'render',
        value: function render() {
            return _react2.default.createElement(_Grid2.default, { columns: _constants.gridColumns, data: this.props.skills });
        }
    }]);
...
},{"./../../../Common/Components/Grid/Grid":1,"./../Actions/skills":3,"./../constants":8,"prop-types":18,"react":"react","react-redux":"react-redux"}],7:[function(require,module,exports){
'use strict';
...
var gridColumns = [{ header: 'Name', field: 'name' }, { header: 'Short name', field: 'shortName' }, { header: 'Category', field: 'category' }];
...
},{"./Reducers/skillsReducer":7,"redux":"redux","redux-thunk":21}],10:[function(require,module,exports){
'use strict';
...
},{"./Pages/Skills/Components/DeleteSkillDialog":4,"./Pages/Skills/Components/EditSkillDialog":5,"./Pages/Skills/Components/SkillsGrid":6,"./Pages/Skills/store":9,"react":"react","react-dom":"react-dom","react-redux":"react-redux"}],11:[function(require,module,exports){
"use strict";
...
},{"./checkPropTypes":15,"./lib/ReactPropTypesSecret":19,"_process":14,"fbjs/lib/emptyFunction":11,"fbjs/lib/invariant":12,"fbjs/lib/warning":13,"object-assign":20}],18:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
